...
class MathSpirit(Game):
    ...
    def description(self):
        ...
        return ("What happens if your math class is haunted... Better not"
                + " to know")
    ...
    def play(self):
        """Play the game."""
        self.say("In the middle of the town they was a very old school"
        ...
        self.say("You have 5 lives if you anwer wrong your live will be"
                 + " deduct.")
        self.say("The game is not that hard, you will have a chance to"
                 + " answer bonus question if your lives = 1")
        self.say("Good Luck")
        self.choice("Type /begin to begin a game: ", ['begin'],
                    self.post_rules)
