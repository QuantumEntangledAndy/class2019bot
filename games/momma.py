...
__author__ = (
    "Ranvir Koknutphongchai, Porsuk Phlalop, Teerasit Saweephanlop"
    + " and Krittin Thasunthorn"
)
__copyright__ = "Copyright 2019, Chulalongkorn University"
__credits__ = [
    "Ranvir Koknutphongchai",
    "Porsuk Phlalop",
    "Teerasit Saweephanlop",
    "Krittin Thasunthorn",
]
__license__ = "AGPL"
__version__ = "1.0.0"
    ...
    def answered_q(self, choices):
        ...
        if self.hard_mode:
            ...
            if answer_reveal == 0:
                ...
                self.say(
                    f"[{name.name}] Why are you asking that? I don’t"
        ...
        if choices == "Hobby" and not name.q_check[0]:
            ...
            self.say(f"\n[The Boy] What is your {choices.lower()}?")
            self.say(
                f"[{name.name}] I love {name.crusine} crusine!"
                + " That's my favourite."
            )
            self.say("[The Boy] Thanks for the answer.\n")
            name.q_check[2] = True
            ...
            self.say(f"\n[The Boy] What is your {choices.lower()}?")
            self.say(
                f"[{name.name}] I like to listen to {name.music_genre}"
                + " songs."
            )
            self.say("[The Boy] Thanks for the answer.\n")
            name.q_check[3] = True
...
class Story(Event):
    ...
    def intro(self):
        """Start the intro."""
        self.say(
            "Once upon a time, in the land of sophisticated innovation,"
            + " the boy accidentally walked into a time machine."
        )
        self.say(
            "[The Boy] Oh! Awwww! My head is aching!! I’m about to throw"
            + " up now! BBLLAARGGHH!!"
        )
        self.say(
            "[The Boy] Oh the machine stop spinning. Where am I now! Oh"
            + " god damn its 1960!"
        )
        self.say(
            "He saw his dad and be able to recognize him. By the way. He"
            + " was shocked that he can’t remember any of his mother’s"
            + " appearance."
        )
        self.say(
            "After wandering around his parent’s college, the boy saw his"
            + " dad talking with a bunch of girls!"
        )
        self.say(
            "[The Boy] Oh my goodness! If he marries another woman,"
            + " beside my mom. What should I do now!! I will not be"
            + " born!!!"
        )
        self.say(
            "The boy cries as loud as rainstorm in the middle of the"
            + " ocean, unknowing of his future that he will still stay"
            + " alive in the time where he came from."
        )
        self.say(
            "Players! We would like you to help us find his real mother,"
            + " in order to let he be survived by investigating four of"
            + " his father’s college girl."
        )
        self.say(
            "Select one of the four that you think that is his real"
            + " mother"
        )
    ...
    def mother_info(self, mom):
        ...
        self.say(
            "Wow... the time machine seems to have erased some of"
            + " my memory... "
        )
    ...
    def direction(self):
        ...
        self.say(
            "[Dad] My son… in order to solve the mystery of who is"
        ...
        self.say2(".\n.")
        self.say(
            "--- Note: You are only allowed to ask two questions per"
            + " girl. ---"
        )
        self.say(
            "--- Note: Different girls may possess similar"
            + " characteristics. ---"
        )
        self.say2(".\n.")
    ...
    def girl_talk(self, name):
        ...
        self.say(
            "[The Boy] I’m sorry to disturb you. Can I ask you"
            + " a few questions?"
        )
    ...
    def end_invest(self):
        ...
        self.say("...")
        self.say(
            "[DAD] So?? Now that you have spoken to all the girls..."
    ...
    def good_end(self):
        ...
        self.say(
            "Years ahead in the future...we find ourselves in a"
            + " delivery room of a hospital."
        )
        self.say(
            "After hours of labour...the anxious parents found peace"
            + " in the sound of a baby wailing..."
        )
        self.say("[BABY] Waah! Waaah!")
        self.say(
            "[PARENTS] Oh my ...what a wonderful baby...he has done"
    ...
    def bad_end(self):
        ...
        self.say(
            "You realised that you have fail your most"
            + " important decision."
        )
        self.say("And that is your last decision...")
        self.say("Your body is fading away... you don't know why...")
        self.say(
            "You chose poorly, and you shall pay the price with your"
            + " existence."
        )
...
class Momma(Game):
    ...
    def post_ask_girl_q(self):
        ...
        self.choice(
            "How would you like to continue?",
            [
                "Ask more question about her",
                "Ask someone else",
                "End the investigation",
            ],
            [self.ask_girl_q, self.pick_girl, self.end_investigation_question],
        )
